    ...
    <div class="glass-card border border-slate-800/80 rounded-2xl p-5"
      ...
      <div class="flex items-start justify-between mb-3">
        <div class="min-w-0">
          ...
          {{-- Fase CY polish v2: single big number PAKAI animasi counter dari equity awal
               range -> equity sekarang (~900ms, ease-out). User minta "dari kecil ke gede
               gitu, masa langsung 150" -- angka tumbuh visible, tiap ganti range jalan lagi. --}}
          <p class="text-2xl font-bold text-slate-100 font-mono mt-1"
             x-text="formatEquity(animatedEquity)"></p>
              ...
              <td class="px-4 py-3 text-center">
                ...
                @php
                  $resultConfig = match($trade->result) {
                    ...
                    'trailing_stop_1pct' => ['bg-orange-500/10 text-orange-400 border-orange-500/30', 'Trailing 1%'],
                    'trailing_stop_1_5pct' => ['bg-orange-500/10 text-orange-400 border-orange-500/30', 'Trailing 1.5%'],
                    'trailing_stop' => ['bg-orange-500/10 text-orange-400 border-orange-500/30', 'Trailing 2%'],
