            ...
            <nav class="app-sidebar-nav flex-1 px-0 py-4 space-y-1 text-sm">
                @php
                    $nav = [
                        ...
                        ['label' => 'Signal Radar', 'route' => 'trades.radar', 'href' => route('trades.radar'), 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'],
                        ['label' => 'Radar Log', 'route' => 'trades.radar-log', 'href' => route('trades.radar-log'), 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4'],
                        ['label' => 'BSJP Tracker', 'route' => 'trades.bsjp-tracker*', 'href' => route('trades.bsjp-tracker'), 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z'],
                    ];
                    if (auth()->user()?->isAdmin()) {
                        ...
                        $nav[] = ['label' => 'Admin Stocks', 'route' => 'admin.stocks.*', 'href' => route('admin.stocks.index'), 'icon' => 'M4 19V5m0 14h16M8 17V9m4 8V7m4 10v-5'];
                    }
                @endphp
                @foreach($nav as $item)
                ...
                <div class="app-topbar-row flex items-center gap-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-cloak x-transition
                            ...
                            @if(auth()->user()?->isAdmin())
                                <a href="{{ route('admin.index') }}" class="block px-4 py-2 text-sm">Admin &amp; Jalankan Manual</a>
                            @endif
