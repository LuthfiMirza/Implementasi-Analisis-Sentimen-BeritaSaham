...
class TradingDecisionService
{
    ...
    public function decide(array $input): array
    {
        ...
        $entrySelected=$actionSelection['selected_proposal']??(new SelectedProposalService())->empty();$managementSelected=$positionManagement['management_selection']['selected_proposal']??(new SelectedProposalService())->empty();$selectedProposal=(($managementSelected['status']??null)==='selected_reference')?$managementSelected:((($entrySelected['status']??null)==='selected_reference')?$entrySelected:(new SelectedProposalService())->empty());
